<?xml version="1.0"?>
<!--This XSLT will use the contents of -->
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- In xslt finding a match does not automatically mean: copy the contents 
   This snippet in the script matches anything and copies it to the output
  ...
  Priority of this match is: .5
  -->
  <xsl:template match="jdfns:JDF/jdfns:ResourcePool/jdfns:CustomerInfo">
    <xsl:copy-of select="."/>
